...
var $1193f60a44983e43$var$scale = (name) => {
  const value = (0, $parcel$interopDefault($62561e92e160ec9a$exports)).quantization?.scales?.[name];
  if (!(value > 0) || !Number.isFinite(value)) throw new Error(`The bundled N8AO neural model has no valid ${name} scale.`);
  return value;
};
if ((0, $parcel$interopDefault($62561e92e160ec9a$exports)).architecture !== "attention-v3-int8" || (0, $parcel$interopDefault($62561e92e160ec9a$exports)).formatVersion !== 3 || (0, $parcel$interopDefault($62561e92e160ec9a$exports)).quantization?.scheme !== "symmetric-int8-per-tensor" || (0, $parcel$interopDefault($62561e92e160ec9a$exports)).quantization?.zeroPoint !== 0 || (0, $parcel$interopDefault($62561e92e160ec9a$exports)).supportedDenoiseSamples?.join(",") !== "4,8,16" || $1193f60a44983e43$var$MATRIX_LAYOUTS.some(([, field, rows, columns]) => (0, $parcel$interopDefault($62561e92e160ec9a$exports))[field]?.length !== rows * columns || (0, $parcel$interopDefault($62561e92e160ec9a$exports))[field].some((value) => !Number.isInteger(value) || value < -127 || value > 127))) throw new Error("The bundled N8AO neural denoise model has an unsupported layout.");
  ...
  useFrame((_, delta) => {
    ...
    if (object) {
      ...
      if (object.userData?.lensflare === "no-occlusion") target = 0;
        ...
        if (object.material.uniforms?._transmission?.value > 0.2) target = 0.2;
