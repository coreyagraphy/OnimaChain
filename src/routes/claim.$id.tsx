...
function ClaimPage() {
  ...
  return <article className="pt-28 wrap">
    ...
    <div className="py-9 border-t hairline text-sm muted">No benefit, safety or personal-use conclusion is issued from this draft record. <Link to="/observatory" search={{ station: 'evidence' }} className="text-cyan underline">Practice evidence reasoning in Evidence Worlds.</Link></div>
  </article>
}
