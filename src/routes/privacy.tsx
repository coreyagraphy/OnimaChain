...
const POINTS = [
  ...
  ['Editorial messages, once enabled', 'The correction form remains closed until a verified sender and inbox delivery test are configured. Once enabled, it sends your page reference, message, optional source URL and optional reply email to the configured editorial inbox through the email provider. Please do not submit medical records or treatment details.'],
  ...
  ['What remains to be verified before release', 'Hosting logs, any analytics or cookies, email-provider retention, correction-message handling and any other service providers need owner and legal review. This draft is not a complete production privacy notice until those facts are checked.'],
...
export const Route = createFileRoute('/privacy')({
  ...
  component: () => (
    <div className="pt-28 wrap min-h-[60vh]">
      ...
      <p className="lede mt-5 max-w-2xl">A code-based inventory for owner review. Infrastructure and retention details still need verification before production release.</p>
      <OperatorIdentity />
      ...
      <p className="mt-8 mono text-[11px] text-bone/45">Release-gated draft · provider and legal review pending.</p>
    </div>
  ),
})
