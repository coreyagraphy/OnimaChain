...
function WatchlistIndex() {
  ...
  return <div className="pt-28 pb-24 research-world watchlist-world">
    <header className="wrap research-hero"><p className="label watchlist-signal">Watchlist signal / emerging research</p><h1 className="display research-heading">What researchers are <span>watching next.</span></h1><p className="lede max-w-3xl mt-6">These compounds aren't necessarily available through OnimaChain. They're here because the research around them is moving and worth following.</p><div className="research-hero-rule" /><p className="mono text-xs text-bone/55">{WATCHLIST.length} tracked molecules · none listed for sale · each development label links to a dated source</p></header>
