...
export const Route = createFileRoute('/coverage')({
  head: () => ({ meta: [{ title: 'Coverage — Cyravon' }] }),
  component: () => (
    <div className="pt-28 wrap">
      <p className="label label-cyan">Coverage</p>
      <h1 className="display text-[clamp(2.6rem,7vw,6.4rem)] mt-3">What Cyravon can and cannot see.</h1>
      <p className="lede mt-5 max-w-2xl">Cyravon never implies &ldquo;the internet says&rdquo;. This page is the denominator for every statement on the site.</p>
