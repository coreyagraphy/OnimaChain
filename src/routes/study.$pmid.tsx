    ...
    return {
      meta: [
        ...
        },
        {
          name: 'description',
          content: title
            ? `Study record for PubMed ID ${params.pmid}.`
            : `PubMed ID ${params.pmid} is not one of the studies we have checked.`,
        },
      ],
    }
  },
  ...
  return (
    <main className="wrap pt-28 pb-24">
      ...
      <p className="mono text-[11px] text-bone/40 mt-2">
        Checked against PubMed on {m.verifiedAt.slice(0, 10)}. We also confirmed the title mentions “{study.expectKeyword}”.
      </p>
